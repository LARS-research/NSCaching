...
python auto_search.py --task_dir=../KG_Data/FB15K --sample=auto --model=SimplE --loss=point --load=False --hidden_dim=200 --lamb=1e-3 --lr=0.0001 --n_epoch=1000 --n_batch=2048 --filter=True --epoch_per_test=20 --test_batch_size=40 --optim=adam --out_file=_auto;
